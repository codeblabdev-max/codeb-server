# CLAUDE.md v7.0.43 - CodeB Unified Deployment System
...
```
VERSION              # 루트의 VERSION 파일이 기준 (현재: 7.0.43)
```
...
| 패키지 | 버전 | 경로 |
|--------|------|------|
| @codeblabdev-max/mcp-server | 7.0.43 | mcp-server |
| @codeblabdev-max/we-cli | 7.0.43 | cli |
| @codeblabdev-max/mcp-proxy | 7.0.43 | cli/mcp-proxy |
...
- **CLI**: @codeblabdev-max/we-cli@7.0.43
- **MCP Server**: @codeblabdev-max/mcp-server@7.0.43
- **MCP Proxy**: @codeblabdev-max/mcp-proxy@7.0.43
