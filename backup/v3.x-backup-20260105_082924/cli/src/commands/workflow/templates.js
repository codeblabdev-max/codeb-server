 ...
 * Template Generators
 *
 * Generates project-specific configuration files:
 * - CLAUDE.md - Project rules for AI agents
 * - DEPLOYMENT_RULES.md - Deployment rules for AI agents
 *
 ...
 * Contains project-specific rules that AI agents must follow
 * @param {string} projectName - Project name
 * @returns {string} CLAUDE.md content
 */
export function generateProjectClaudeMd(projectName) {
 ...
 */
export function generateDeploymentRules() {
